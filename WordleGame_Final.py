...
def game_wordle(category):
    ...
    country = ["japan", "italy", "morocco", "finland", "egypt", "pakistan", "vietnam", "china", "chile","wales"]
    animal = ["tiger", "eagle", "vulture", "lizard", "turtle", "giraffe", "shark", "capybara", "python", "shrimp"]
    color = ["fuchsia", "yellow", "black", "violet", "green", "white", "orange", "maroon", "indigo", "crimson"]
